...
Bridge.assembly("ClassicForms", function ($asm, globals) {
    ...
    Bridge.define("System.ComponentModel.BinaryReader", {
        fields: {
            Data: null,
            Position: 0
        },
        ...
        methods: {
            ReadString: function () {
                ...
                var charArry = System.Array.init(length, 0, System.Char);

                for (var i = 0; i < length; i = (i + 1) | 0) {
                    charArry[System.Array.index(i, charArry)] = this.ReadChar();
                }

                return System.String.fromCharArray(charArry);
            },
            ReadChar: function () {
                return this.Data[Bridge.identity(this.Position, ((this.Position = (this.Position + 1) >>> 0)))];
            },
            ReadByte: function () {
                return this.Data[Bridge.identity(this.Position, ((this.Position = (this.Position + 1) >>> 0)))];
            },
            ReadInt: function () {
                return System.BitConverter.toInt32(System.Array.init([this.Data[Bridge.identity(this.Position, ((this.Position = (this.Position + 1) >>> 0)))], this.Data[Bridge.identity(this.Position, ((this.Position = (this.Position + 1) >>> 0)))], this.Data[Bridge.identity(this.Position, ((this.Position = (this.Position + 1) >>> 0)))], this.Data[Bridge.identity(this.Position, ((this.Position = (this.Position + 1) >>> 0)))]], System.Byte), 0);
            },
            ReadBinary: function () {
                var length = (this.ReadInt()) >>> 0;
                var byteArry = new Uint8Array(length);

                for (var i = 0; i < length; i = (i + 1) >>> 0) {
                    byteArry[i] = this.Data[((i + this.Position) >>> 0)];
                }
    ...
    Bridge.define("System.ComponentModel.ComponentResourceManager", {
        statics: {
            fields: {
                resourceCache: null
            },
            ctors: {
                init: function () {
                    this.resourceCache = new (System.Collections.Generic.Dictionary$2(System.Type,System.ComponentModel.ResourceReader)).ctor();
                }
            }
        },
        fields: {
        ...
        ctors: {
            ctor: function (type) {
                ...
                this.Path = System.String.format("/resources/{0}/", [Bridge.Reflection.getTypeFullName(this.Type)]);

                if (!System.ComponentModel.ComponentResourceManager.resourceCache.containsKey(this.Type)) {
                    throw new System.Exception("Please call Form.LoadResourcesAsync() before using ComponentResourceManager.");
                } else {
                    this.resourceReader = System.ComponentModel.ComponentResourceManager.resourceCache.getItem(this.Type);
                }
            }
        },
        methods: {
            GetObject: function (name) {
                var $t;
                return ($t = new System.UInt8Holder(), $t.Array = this.resourceReader.GetObject(name), $t);
            },
            GetString: function (name) {
                return this.resourceReader.GetString(name);
            }
        }
    });
    ...
    Bridge.define("System.ComponentModel.ResourceReader", {
        fields: {
            Data: null
        },
        ctors: {
            init: function () {
                this.Data = new (System.Collections.Generic.Dictionary$2(System.String,System.Object)).ctor();
            }
        },
        methods: {
            GetString: function (name) {
                return Bridge.unbox(this.Data.getItem(name));
            },
            GetObject: function (name) {
                return Bridge.unbox(this.Data.getItem(name));
            }
    ...
    Bridge.define("System.DateHelper", {
        statics: {
            methods: {
                FromBinaryRaw: function (dateData) {
                    var num = dateData.and(System.Int64([-1,1073741823]));
                    if ((num.lt(System.Int64(0))) || (num.gt(System.Int64([-197705729,734668917])))) {
                        throw new System.ArgumentException.$ctor3(System.EnvironmentV2.GetResourceString("Argument_DateTimeBadBinaryData"), "dateData");
                    }
                    // TODO:-SUpport ULONG DATE...
                    return System.DateTime.create$2(dateData);
                },
                FromBinary: function (dateData) {
                    //long num2;
                    if ((dateData.and(System.Int64([0,-2147483648]))).equals(System.Int64(0))) {
                        return System.DateHelper.FromBinaryRaw(dateData);
                    }
                    var ticks = dateData.and(System.Int64([-1,1073741823]));
                    if (ticks.gt(System.Int64([-711573504,1073741622]))) {
                        ticks = ticks.sub(System.Int64([0,1073741824]));
                    }
                    ...
                    //}
                    //ticks += num2;
                    if (ticks.lt(System.Int64(0))) {
                        ticks = ticks.add(System.Int64([711573504,201]));
                    }
                    if ((ticks.lt(System.Int64(0))) || (ticks.gt(System.Int64([-197705729,734668917])))) {
                        throw new System.ArgumentException.$ctor3(System.EnvironmentV2.GetResourceString("Argument_DateTimeBadBinaryData"), "dateData");
                    }
                    return System.DateTime.create$2(ticks, 2);
                }
            }
        }
    });

    Bridge.define("System.Drawing.Image", {
        statics: {
            methods: {
                op_Explicit: function (arr) {
                    var x = new System.Drawing.Image();

                    var blob = new Blob(System.Array.init([arr.Array], Uint8Array), { type: "image/png" });
    ...
    Bridge.define("System.Settings", {
        statics: {
            fields: {
                ...
                WinFormButtonSide: 0,
                OnComponentResourceManagerGetString: null,
                OnComponentResourceManagerGetObject: null,
                UseNativeResource: false,
    ...
    Bridge.define("System.TypedReference", {
        $kind: "struct",
        statics: {
            methods: {
                getDefaultValue: function () { return new System.TypedReference(); }
            }
        },
        fields: {
            Value: 0,
        ...
        methods: {
            getHashCode: function () {
                var h = Bridge.addHash([5271954304, this.Value, this.Type]);
                return h;
            },
            equals: function (o) {
                if (!Bridge.is(o, System.TypedReference)) {
                    return false;
                }
                return Bridge.equals(this.Value, o.Value) && Bridge.equals(this.Type, o.Type);
            },
            $clone: function (to) {
                var s = to || new System.TypedReference();
                s.Value = this.Value;
                s.Type = this.Type;
                return s;
            }
    ...
    Bridge.define("System.UInt8Holder", {
        fields: {
            Array: null
        }
    });
    ...
    Bridge.define("System.Drawing.Bitmap", {
    ...
    Bridge.define("System.Windows.Forms.PictureBox", {
        inherits: [System.Windows.Forms.Control,System.ComponentModel.ISupportInitialize],
        fields: {
            cBackgroundImageLayout: 0,
            cBackgroundImage: null
        },
        props: {
            BackgroundImageLayout: {
                get: function () {
                    return this.cBackgroundImageLayout;
                },
                set: function (value) {
                    this.Element.style.backgroundSize = null;
                    this.Element.style.backgroundRepeat = "no-repeat";
                    this.Element.style.backgroundAttachment = null;
            ...
            BackgroundImage: {
                get: function () {
                    return this.cBackgroundImage;
                },
                set: function (value) {
                    this.Element.style.backgroundImage = System.String.format("url('{0}')", [((this.cBackgroundImage = value)).Data]);
                }
            }
        },
        alias: [
        ...
        ctors: {
            init: function () {
                this.cBackgroundImageLayout = System.Windows.Forms.ImageLayout.None;
            },
            ctor: function () {
                this.$initialize();
                System.Windows.Forms.Control.ctor.call(this, document.createElement("div"));
    ...
    Bridge.define("System.Windows.Forms.Form", {
        ...
        statics: {
            ...
            methods: {
                LoadResourcesAsync: function (mainAssembly) {
                    var $step = 0,
                        $task1, 
                        $taskResult1, 
                        $jumpFromFinally, 
                        ...
                        $asyncBody = Bridge.fn.bind(this, function () {
                            try {
                                for (;;) {
                                    ...
                                    switch ($step) {
                                        case 0: {
                                            types = System.Linq.Enumerable.from(Bridge.Reflection.getAssemblyTypes(mainAssembly), System.Type).where(function (o) {
                                                return Bridge.referenceEquals(Bridge.Reflection.getBaseType(o), System.Windows.Forms.Form);
                                            });
                                        ...
                                        case 3: {
                                            $task1 = System.Threading.Tasks.Task.fromPromise(func1("GET", System.String.format("/Resources/{0}.{1}.bin", Bridge.Reflection.getTypeNamespace(item), Bridge.Reflection.getTypeName(item))));
                                            $step = 4;
                                        ...
                                        case 4: {
                                            ...
                                            arrayBuffer = ($taskResult1);

                                            try {
                                                if (arrayBuffer == null || arrayBuffer.length === 0 || arrayBuffer[System.Array.index(0, arrayBuffer)] == null) {
                                                    $step = 2;
                                                    continue;
                                                }

                                                arry = Bridge.cast(arrayBuffer[System.Array.index(0, arrayBuffer)], Uint8Array);

                                                binaryReader = new System.ComponentModel.BinaryReader(arry);
                                                resourceReader = new System.ComponentModel.ResourceReader();

                                                if (!!(binaryReader.ReadChar() === 83 & binaryReader.ReadChar() === 71)) {
                                                    fields = binaryReader.ReadInt();

                                                    for (var i = 0; i < fields; i = (i + 1) | 0) {
                                                        name = binaryReader.ReadString();
                                                        type = binaryReader.ReadInt();
                                                    ...
                                                    System.ComponentModel.ComponentResourceManager.resourceCache.add(item, resourceReader);
    ...
    Bridge.define("System.Windows.Forms.Panel", {
        ...
        props: {
            ...
            AutoScroll: {
                get: function () {
                    return Bridge.referenceEquals(this.Element.style.overflow, "auto");
                },
                set: function (value) {
                    if (value) {
